<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminSections.aspx.cs" Inherits="AdminSections" %>
...
<body>
    <form id="form1" runat="server">
        <div class="nav">
            ...
            <a href="AdminSections.aspx" class="active" onclick="showAttendance()">Section Allocation</a>
