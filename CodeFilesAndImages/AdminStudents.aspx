<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminStudents.aspx.cs" Inherits="AdminStudents" %>
...
<body>
    <form id="form1" runat="server">
        <div class="nav">
            ...
            <a href="AdminStudents.aspx" class="active" onclick="showTranscript()">Student Allocation</a>
